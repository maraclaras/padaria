...
export default function WireframeConsultaProdutos() { return ( <div className="flex items-center justify-center min-h-screen bg-gray-100 p-6"> <div className="w-full max-w-4xl bg-white rounded-2xl shadow p-6"> <h1 className="text-xl font-bold mb-4 text-center"> Wireframe - Consulta de Produtos </h1>
...
{/* Barra de busca */}
    <div className="flex mb-4">
      <input
        ...
        className="flex-grow rounded-l-lg border-gray-300 shadow-sm px-3"
      />
